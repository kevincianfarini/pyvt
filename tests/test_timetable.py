...
from py_vt.timetable import TimetableError, Timetable
...
class TestTimetableHelpers(TestCase):
    ...
    @patch('py_vt.timetable.Timetable._parse_row')
...
class TestTimetableLookups(TestCase):
    ...
    @patch('py_vt.timetable.Timetable._make_request')
    @patch('py_vt.timetable.Timetable._parse_table')
    ...
    @patch('py_vt.timetable.Timetable.refined_lookup')
